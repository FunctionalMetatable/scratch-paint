...
class Playground extends React.Component {
    ...
    downloadImage() {
        ...
        if (format === 'png' || format === 'jpg') {
            ...
            doc.querySelector('svg').insertAdjacentHTML(
                'beforeend',
                document.getElementById('scratch-font-styles').outerHTML
            );
    ...
    render() {
        return (
            <div className={styles.wrapper}>
                <div>
                    {!this.costumeFound && (
                        <Modal title="Choose your costume">
                    ...
                    <Button2Component
                        ...
                        onClick={() => {
                            ...
                            reader.onerror = (ex) =>
                                alert(
                                    'Your request to get a dataURL could not be fulfilled.\nError:\n\n' +
                                        ex
                                );
                        }}
                    >
