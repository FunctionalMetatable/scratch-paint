...
const messages = defineMessages({
    ...
    reshape: {
        ...
        description:
            'Label for the reshape tool, which allows changing the points in the lines of the vectors',
    ...
    select: {
        ...
        description:
            'Label for the select tool, which allows selecting, moving, and resizing shapes',
